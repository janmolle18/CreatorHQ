...
CREATE TYPE "public"."source_status" AS ENUM('discovered', 'downloading', 'downloaded', 'clipping', 'clipped', 'failed');--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "briefings" (
	...
	CONSTRAINT "briefings_briefing_date_unique" UNIQUE("briefing_date")
);
...
CREATE TABLE IF NOT EXISTS "comments" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "uq_comments_platform_external" UNIQUE("platform","external_comment_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "metrics_snapshots" (
	...
	CONSTRAINT "uq_snapshot_date_account_post" UNIQUE NULLS NOT DISTINCT("snapshot_date","account_id","post_id")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "settings" (
	...
	"creator_name" text DEFAULT 'David' NOT NULL,
...
CREATE TABLE IF NOT EXISTS "source_videos" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "uq_source_platform_external" UNIQUE("platform","external_id")
);
--> statement-breakpoint
DO $$ BEGIN
